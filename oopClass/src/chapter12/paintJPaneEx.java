...
public class paintJPaneEx extends JFrame{
	...
	class MyPanel extends JPanel{
		public void paintComponent(Graphics g) {
			...
			g.drawRect(10, 10, 50, 50); // (10, 10) 위치에 50 x 50 크기의 사각형 그리기
			g.drawRect(50, 50, 50, 50); // (50, 50) 위치에 50 x 50 크기의 사각형 그리기
			g.setColor(Color.MAGENTA); // 마젠타색 선택
			g.drawRect(90, 90, 50, 50); // (90, 90) 위치에 50 x 50 크기의 사각형 그리기
		}
	}
